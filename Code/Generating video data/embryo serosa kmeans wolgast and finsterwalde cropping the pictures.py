...
for i in range(32):
    crop = io.imread(output_folder+'embryo serosa Kmeans scaled rotation0 t{}.tif'.format(i))[22:884,461:929]
    io.imsave(output_folder+       'cropped embryo serosa Kmeans scaled rotation0 t{}.tif'.format(i), crop)
    
    crop = io.imread(output_folder+'embryo serosa Kmeans unscaled rotation0 t{}.tif'.format(i))[22:884,461:929]
    io.imsave(output_folder+       'cropped embryo serosa Kmeans unscaled rotation0 t{}.tif'.format(i), crop)
    ...
    io.imsave(output_folder+       'cropped embryo serosa Kmeans unscaled rotation1 t{}.tif'.format(i), crop)
