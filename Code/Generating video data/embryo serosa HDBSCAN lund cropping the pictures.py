...
for i in range(25):
    crop = io.imread(output_folder+'HDBSCAN embryo serosa rotation0 t{}.tif'.format(i))[22:884,445:945]
    ...
    io.imsave(output_folder+       'cropped HDBSCAN embryo serosa rotation1 t{}.tif'.format(i), crop)
