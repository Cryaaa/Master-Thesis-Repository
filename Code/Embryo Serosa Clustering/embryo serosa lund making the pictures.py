...
lund_embedding = np.load('lund embryo serosa embedding.npy')
lund_prediction = np.load('lund embryo serosa presdiction.npy')




image_output_folder = 'C:/Users/ryans/OneDrive/Documents/Master Thesis/Documents/Figures/Embryo Serosa Clustering Lund//'
rotations_lund = [(0,130,0),(0,180,0),(0,230,0)]
cmap_napari = tc.napari_label_cmap()

            
for time in [0]:
    nice_screenshots_of_1_timepoint(lund,lund_prediction,
